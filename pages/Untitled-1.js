;<div className="text-alignment space-y-7">
  ...
  <ul className="h5 list-disc mx-6">
    ...
    <li className="leading-10">
      Мы верим в человеческую природу Иисуса Христа, в Его непорочное зачатие, безгрешную
      жизнь, чудеса, заместительную и искупительную смерть через Его пролитую кровь, в Его
      телесное воскресение и вознесение одесную Отца (Матфея 1:18,25; 1 Коринфянам 15:1-8;
      Евреям 4:15; Деяния 1:9-11; Деяния 2:22-24).
    </li>
    <li className="leading-10">
    ...
    <li className="leading-10">
      Мы верим в личное и физическое второе пришествие Иисуса Христа (Матфея 24:30; Деяния
      1:10-11).
    </li>
    <li className="leading-10">
