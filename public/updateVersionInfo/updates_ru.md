...
### **Добавлено:**
- метод проверки перевода для команды GL
- опция в методах для цитат в TN
- функция быстрого распределение стихов
- режим только для чтения для участия переводчика в переводе главы
