...
## Installation/First Steps V-CANA Online
...
## Installation/First Steps V-CANA Intranet
...
We recommend copying it to the /opt folder.

The entire installation will not require an Internet connection.
...
literal Bible, simplified Bible, tNotes, tWords, tWordLinks, tQuestions, Greek Bible and Hebrew Bible.
...
### Creating a project
 ...
 Fill in all the fields in the tab "Create a project"
  ...
  ```sh    
  literal: http://192.168.1.12:4008/unfoldingWord/en_ult/src/commit/master
  simplified: http://192.168.1.12:4008/unfoldingWord/en_ult/src/commit/master
  tnotes: https://192.168.1.12:4008/unfoldingWord/en_tn/commit/master
  tquestions: https://192.168.1.12:4008/unfoldingWord/en_tq/commit/master
  twords: https://192.168.1.12:4008/unfoldingWord/en_twl/commit/master
  ```
  or

  ```sh    
  obs: https://192.168.1.12:4008/unfoldingWord/en_obs/commit/master    
  tnotes: https://192.168.1.12:4008/unfoldingWord/en_obs-tn/commit/master
  tquestions: https://192.168.1.12:4008/unfoldingWord/en_obs-tq/commit/master
  twords: https://192.168.1.12:4008/unfoldingWord/en_obs-twl/commit/master
  ```
Then click ```Create project```
