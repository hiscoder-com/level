              ...
              verses: [
                {
                  id: 1,
                  verse: '5',
                  text: ' Затем Бог сказал: «Пусть на земле растут деревья и растения разных видов!» Так и произошло. Бог посмотрел на созданное Им и увидел, что это хорошо.',
                },
                {
                  id: 2,
                  verse: '6',
                  text: ' На четвёртый день творения Бог сказал: «Пусть будут светила в небе!» И в небе появились солнце, луна и звёзды. Бог создал их для того, чтобы они освещали землю и чтобы по ним можно было определять дни и ночи, годы и времена года. Бог посмотрел на созданное Им и увидел, что это хорошо.',
                },
              ],
            },
          },
