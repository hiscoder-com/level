...
function ModalInSideBar({
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="absolute flex flex-col right-0 top-0 w-full h-full min-h-full bg-th-secondary-10 z-10 md:h-min ml-4 lg:ml-0 pb-3 sm:pb-7 overflow-auto sm:overflow-visible cursor-default shadow-md border-th-secondary-300 sm:border md:max-h-full md:left-full lg:w-[30rem] rounded-none md:rounded-xl lg:rounded-none"
