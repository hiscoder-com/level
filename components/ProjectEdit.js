...
function ProjectEdit({ code }) {
  ...
  const assignTranslator = async () => {
    ...
    axios
      .post(`/api/projects/${code}/assign-roles/translators/`, {
  ...
  return (
    <div>
      ...
      <div className=" grid grid-cols-8 gap-2 ">
        ...
        <DialogUI open={open} setSelectedUser={setSelectedUser} setOpen={setOpen}>
          <select
...
function DialogUI({ open, setOpen, children, setSelectedUser }) {
