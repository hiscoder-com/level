    ...
    <>
      <div className="py-0 sm:py-10" onClick={(e) => e.stopPropagation()}>
        <form className="flex flex-col gap-0 md:gap-4" onSubmit={handleSubmit(onSubmit)}>
          <div className="card-md py-7 space-y-7 bg-transparent sm:bg-th-background-tertiary">
          ...
          <div className="card-md bg-transparent sm:bg-th-background-tertiary flex flex-col gap-7 py-7">
          ...
          <div className="card-md bg-transparent sm:bg-th-background-tertiary flex flex-col gap-7 pb-7 mb-7 border-b border-th-border-primary">
