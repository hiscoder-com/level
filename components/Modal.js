...
function Modal({
  ...
  const classNames = {
    ...{
      ...
      dialogPanel:
        'w-full max-w-md p-6 align-middle transform overflow-y-auto shadow-xl transition-all bg-gradient-to-r from-th-primary-modal-from to-th-primary-modal-to text-blue-250 rounded-3xl',
