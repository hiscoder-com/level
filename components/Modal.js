...
function Modal({
  ...
  const classNames = {
    ...{
      ...
      dialogPanel:
        'w-full max-w-md p-6 align-middle transform overflow-y-auto shadow-xl transition-all bg-gradient-to-r from-th-primary-100 to-th-primary-100 text-th-text-secondary rounded-3xl',
