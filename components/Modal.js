...
function Modal({
  ...
  const classNames = {
    ...{
      ...
      dialogPanel:
        'w-full max-w-md p-6 align-middle transform overflow-y-auto shadow-xl transition-all bg-gradient-to-r from-th-modal-from to-th-modal-to text-th-text-secondary rounded-3xl',
