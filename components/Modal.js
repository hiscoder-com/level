...
function Modal({
  ...
  const classNames = {
    ...{
      ...
      dialogPanel:
        'w-full max-w-md p-6 align-middle transform overflow-y-auto shadow-xl transition-all  bg-gradient-to-r from-slate-700 to-slate-500 text-blue-250 rounded-3xl',
