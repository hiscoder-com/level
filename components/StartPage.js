...
function StartPage({ children }) {
  ...
  return (
    <>
      ...
      <main className="flex lg:hidden flex-col gap-5 h-[80vh] p-5 -mt-14 font-bold">
        <div className="grid grid-cols-2 gap-5 text-center">
          <div className="p-6 bg-th-secondary-10 rounded-xl">Language</div>
          <div className="p-6 bg-th-secondary-10 rounded-xl">
            <VcanaLogo />
          </div>
          <div className="p-6 bg-th-secondary-10 rounded-xl">Партнёры</div>
          <div className="p-6 text-th-text-secondary bg-th-primary-100 rounded-xl">
            Обновления
          </div>
        </div>
        <div className="p-6 bg-th-secondary-10 rounded-xl">
