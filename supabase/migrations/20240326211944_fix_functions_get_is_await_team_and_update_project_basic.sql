alter table "public"."languages" add column "is_rtl" boolean default false;

alter table "public"."projects" add column "is_rtl" boolean default false;

alter table "public"."steps" add column "subtitle" text;
