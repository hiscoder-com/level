...
CREATE OR REPLACE FUNCTION "public"."get_max_sorting"("table_name" "text") RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
    DECLARE
...
ALTER FUNCTION "public"."get_max_sorting"("table_name" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."move_node"("new_sorting_value" integer, "dragged_node_id" character varying, "new_parent_id" character varying, "table_name" "text", "project_id" bigint) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $_$
    DECLARE
      old_sorting INT;
...
ALTER FUNCTION "public"."move_node"("new_sorting_value" integer, "dragged_node_id" character varying, "new_parent_id" character varying, "table_name" "text", "project_id" bigint) OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."get_max_sorting"("table_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_max_sorting"("table_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_max_sorting"("table_name" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."move_node"("new_sorting_value" integer, "dragged_node_id" character varying, "new_parent_id" character varying, "table_name" "text", "project_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."move_node"("new_sorting_value" integer, "dragged_node_id" character varying, "new_parent_id" character varying, "table_name" "text", "project_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."move_node"("new_sorting_value" integer, "dragged_node_id" character varying, "new_parent_id" character varying, "table_name" "text", "project_id" bigint) TO "service_role";
